...
export const metadata: Metadata = {
  ...
  description:
    "Free stock average calculator, paycheck calculator hourly, emergency fund calculator, UTM builder, robots.txt builder, UUID generator, HEIC to PNG converter, and HEIC to PDF converter. No signup. Every tool runs in your browser.",
};
