...
export const metadata: Metadata = {
  ...
  description:
    "Free stock average calculator, paycheck calculator hourly, UTM builder, robots.txt builder, UUID generator, and HEIC to PNG converter. No signup. Every tool runs in your browser.",
};
